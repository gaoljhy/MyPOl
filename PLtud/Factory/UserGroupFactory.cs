...
namespace shop.Core.Factory
{
    public class UserGroupFactory
    {
        ...
        {
            string sql = "INSERT INTO shop_usergroup(groupid,groupname,picurl,grouplevel,isdefalut,upgradejf,discount) VALUES(?groupid,?groupname,?picurl,?grouplevel,?isdefalut,?upgradejf,?discount)";
        ...
        {
            string sql = "delete from shop_usergroup where groupid=" + groupid.ToString();
        ...
        {
            string sql = "UPDATE shop_usergroup set groupname=?groupname,picurl=?picurl,grouplevel=?grouplevel,isdefalut=?isdefalut,upgradejf=?upgradejf,discount=?discount where groupid=?groupid";
            MySqlParameter[] parameters = {
        ...
        {
            string sql = "select * from shop_usergroup where groupid=" + groupid;
        ...
        {
            string sql = string.Format("select * from shop_usergroup {0} order by grouplevel asc", whereSql);
