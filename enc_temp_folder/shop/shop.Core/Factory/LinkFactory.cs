...
namespace shop.Core.Factory
{
    public class LinkFactory
    {
        public static void Add(LinkModel model)
        {
            ...
            strSql.Append("insert into shop_link(");
        ...
        {
            string sql = "delete from shop_link where linkid=" + linkid;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update shop_link set ");
        ...
        {
            string sql = "select * from shop_link where linkid = " + linkid;
        ...
        {
            string sql1 = "select * from shop_link order by orderno asc";
            string sql2 = "select * from shop_link where possymbol='" + possymbol + "' order by orderno asc";
