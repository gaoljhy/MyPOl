...
namespace shop.Core.Factory
{
    public class AdminFactory
    {
        ...
        {
            string sql = "INSERT INTO shop_admin(username,userpwd,email,tel,usertype,lastlogindate,createdate,lastloginip,logincount,adminqx) VALUES(?username,?userpwd,?email,?tel,?usertype,?lastlogindate,?createdate,?lastloginip,?logincount,?adminqx)";
        ...
        {
            string sql = "delete from shop_admin where adminid=" + adminid.ToString();
        ...
        public static void Update(AdminModel model)
        {
            ...
            strSql.Append("update shop_admin set ");
        ...
        {
            string sql = "select * from shop_admin where adminid=" + adminid.ToString();
        ...
        {
            string sql = "select * from shop_admin where username='" + username + "'";
