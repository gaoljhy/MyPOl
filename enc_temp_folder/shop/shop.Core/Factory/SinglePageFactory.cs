...
namespace shop.Core.Factory
{
    public class SinglePageFactory
    {
        ...
        {
            string sql = @"INSERT INTO shop_singlepage(serialno ,title ,content) VALUES (?serialno,?title,?content)";
        ...
        {
            string sql = "delete from shop_singlepage where pageid=" + pageid;
            MySqlDbHelper.ExecuteSql(sql);
        }

        public static void Update(SinglePageModel model)
        {
            string sql = @"update shop_singlepage set 
                            serialno = ?serialno,
                            title = ?title,
        ...
        {
            string sql = "select * from shop_singlepage where pageid = " + pageid;
        ...
        {
            string sql = "select * from shop_singlepage where serialno = '" + serialno + "'";
        ...
        {
            string sql = "select * from shop_singlepage  order by pageid asc";
