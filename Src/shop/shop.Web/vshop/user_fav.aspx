<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_fav.aspx.cs" Inherits="shop.Web.vshop.user_fav" %>
<%@ Import Namespace="shop.Core.Common" %>
<%@ Import Namespace="shop.Core.Model" %>
<%@ Import Namespace="shop.Core.Factory" %>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
